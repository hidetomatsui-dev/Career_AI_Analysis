...
■ 今後のキャリアアクション
あなたが「世の中を美しくするための創造的な活動を通して貢献する」というキャリアの軸を実現するために、今のあなたに最も必要なアクションを提案します。「今すぐ」「3ヶ月以内」「1年以内」の3段階で、なぜそのアクションが必要か・何を目指すためのステップかを明記しながら、背中を押すような語りかけるトーンで具体的に記述してください。`;
